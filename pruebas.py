...
print(agenda1.participantes.nombre)
print(agenda1.apartados.apartado)
print(agenda1.apartados.puntos.punto)
print(agenda1.apartados.puntos.discusiones.persona.nombre)
